...
const ForgetPassword = () => {
  ...
  const handleSubmitForgotPassword = async (
    ...
    e.preventDefault();
    try {
      const response = await axiosInstance.post("/api/reset/password/getlink", {
        email,
      });
      ...
      if (response.data.success) {
        ...
        navigate("/emailsent"); // Preusmjerite korisnika na stranicu za prijavu nakon što pošaljete zahtjev za zaboravljenu lozinku
      } else {
  ...
  return (
    <>
      ...
      <Box
        style={
          isMatch
            ? styles.largerScreen.forgotPasswordText
            : styles.smallerScreen.forgotPasswordText
        }
      >
        <Box
          style={
