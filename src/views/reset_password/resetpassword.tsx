...
const ResetPassword = () => {
  ...
  return (
    <>
      ...
      <Box style={isMatch ? styles.largerScreen.resetPasswordText : styles.smallerScreen.resetPasswordText}>
        <Box style={isMatch ? styles.largerScreen.loginForm : styles.smallerScreen.loginForm}>
          <Typography variant="body1" style={{ marginBottom: '8px', textAlign: 'center', fontSize: '18px', color: '#32675B' }}>RESET PASSWORD</Typography>
          <TextField
            label="New password"
            variant='filled'
